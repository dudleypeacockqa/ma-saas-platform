...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*solutioning" workflow="C:\Projects\ma-saas-platform/bmad/bmm/workflows/3-solutioning/workflow.yaml">Design Technical Game Solution</item>
    <item cmd="*tech-spec" workflow="C:\Projects\ma-saas-platform/bmad/bmm/workflows/3-solutioning/tech-spec/workflow.yaml">Create Technical Specification</item>
