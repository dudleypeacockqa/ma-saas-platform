...
class RecordingSession(Base):
    ...
    host_user_id = Column(UUID(as_uuid=False), ForeignKey("users.id"), nullable=False)
...
class PodcastComment(Base):
    ...
    # Comment details
    user_id = Column(UUID(as_uuid=False), ForeignKey("users.id"), nullable=True)  # Registered user
