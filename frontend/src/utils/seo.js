...
export const SEO_CONFIG = {
  ...
  defaultDescription: "Transform your M&A expertise with our comprehensive platform. Tools, community, and insights for successful deal-making. Join thousands of professionals building wealth through strategic acquisitions.",
  ...
  organizationSchema: {
    ...
    "description": "Leading M&A platform providing tools, community, and expertise for successful business acquisitions and wealth building.",
    "foundingDate": "2025",
...
export const generateSEOMetadata = (page) => {
  ...
  const pageConfigs = {
    home: {
      ...
      description: "Join the leading M&A platform with tools, community, and expert guidance. Start your journey to successful business acquisitions and wealth building today.",
      keywords: "M&A platform, business acquisition, dealmaker tools, mergers acquisitions, deal sourcing"
    },
    pricing: {
      title: "M&A Platform Pricing - Solo, Growth & Enterprise Plans",
      description: "Choose the perfect M&A platform plan for your needs. From solo dealmakers to enterprise teams. Start with our 14-day free trial.",
      keywords: "M&A platform pricing, business acquisition tools cost, dealmaker subscription plans"
    },
    community: {
      title: "M&A Community - Connect with Expert Dealmakers",
      description: "Join thousands of M&A professionals sharing insights, deals, and strategies. Network with successful dealmakers and grow your expertise.",
    ...
    podcast: {
      ...
      description: "Weekly podcast featuring M&A experts, successful dealmakers, and actionable strategies for business acquisitions and wealth building.",
    ...
    blog: {
      ...
      description: "In-depth articles on M&A strategies, market analysis, deal structures, and success stories from experienced dealmakers.",
...
export const AI_SEARCH_OPTIMIZATION = {
  ...
  serviceSchema: {
    ...
    "description": "Comprehensive M&A platform with tools, community, and consulting services for successful business acquisitions and wealth building.",
    "offers": [
      {
        "@type": "Offer",
